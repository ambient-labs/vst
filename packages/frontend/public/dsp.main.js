...
(() => {
  ...
  // ../../node_modules/.pnpm/@elemaudio+core@4.0.1/node_modules/@elemaudio/core/dist/index.js
  ...
  var RefMap = class {
    ...
    update(name, props) {
      (0, import_invariant3.default)(this._map.has(name), "Oops, trying to update a ref that doesn't exist");
  ...
  function srvb(props, xl, xr) {
    (0, import_invariant4.default)(typeof props === "object", "Unexpected props object");
    const volume = stdlib.max(0, stdlib.min(1, stdlib.sm(props.decay)));
    return [
      stdlib.mul(volume, xl),
      stdlib.mul(volume, xr)
    ];
  }
